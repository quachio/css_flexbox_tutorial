...
app.get('/example-2/nested-menu', (req, res) => {
  console.log(req.url);
  res.sendFile(__dirname + '/example-2' + '/nested-menu.html');
});

app.get('/example-2/style.css', (req, res) => {
  console.log(req.url);
  res.sendFile(__dirname + '/example-2' + '/style.css');
});
